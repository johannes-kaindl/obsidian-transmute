...
- [Codeberg](https://codeberg.org/jkaindl/obsidian-transmute) is the canonical, primary remote (`origin`).
- The [GitHub repository](https://github.com/johannes-kaindl/obsidian-transmute) is a **mirror** only (used for the community plugin registry and release CI). Open your contributions against Codeberg.
...
- File issues and open pull requests on **Codeberg**: <https://codeberg.org/jkaindl/obsidian-transmute>. (GitHub is a mirror, not the place for contributions.)
