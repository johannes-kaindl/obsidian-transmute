// uebernommen aus koda-agent/src/obsidian/lab.ts, 2026-09-17 (dort selbst uebernommen aus
// vault-rag/src/lab_client.ts, 2026-09-17 — dritte Kopie, die Kette bleibt sichtbar;
// vault-rag selbst uebernahm den Defensiv-Lese-Bauplan aus
// koda-agent/src/obsidian/retrieval.ts, 2026-08-22). apiVersion 4 (turnId), unveraendert
// aus koda-agent uebernommen.
...
export interface LabLogInput {
  ...
  contextPaths?: string[];
  /** Der stabile Anteil des System-Prompts (ohne die konkrete Probe) — Grundlage des
   *  Prompt-Fassungsvergleichs im Lab. */
  promptTemplate?: string;
  /** Klammert mehrere Aufrufe, die zu EINER Nutzer-Handlung gehoeren (hier: eine
   *  Diagnose gehoert zum Stand, der sie ausgeloest hat). */
  turnId?: string;
}
